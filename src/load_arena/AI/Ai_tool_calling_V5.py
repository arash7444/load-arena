...
if __name__ == "__main__":
    ...
    # prompt = """
    # Compare WSPgl._[m/s] and Blade Flapwise moment.
    # Which channel is more variable based on their standard deviations?
    # """
    # prompt = "Compare flapwise loads on Blade 1, Blade 2 and Blade 3."

    prompt = "Tell me about the gearbox temperature."

    response = ask_ai(df, prompt=prompt)
